            ...
            <div className="flex flex-col md:flex-row justify-center items-center mt-8 space-y-4 md:space-y-0 md:space-x-6">
              <div className="md:w-1/2 text-left">
                ...
                <p className="mb-6 leading-relaxed">
                  Endoskopia to nowoczesna technika diagnostyczna i terapeutyczna,
                  która pozwala na szczegółowe oglądanie wnętrza ciała pacjenta za
                  pomocą specjalnej kamery umieszczonej na końcu giętkiego przewodu.
                  Zabiegi endoskopowe umożliwiają precyzyjne diagnozowanie i leczenie
                  wielu schorzeń przewodu pokarmowego, układu oddechowego czy układu
                  moczowego bez konieczności przeprowadzania otwartych operacji. Dzięki
                  temu pacjenci mogą liczyć na krótszy czas rekonwalescencji i minimalizację
                  ryzyka powikłań. W naszej klinice oferujemy kompleksową opiekę w zakresie
                  diagnostyki i leczenia metodami endoskopowymi.
                </p>
                <p className="mb-6 leading-relaxed">
                  Znieczulenie do endoskopii jest to krótkotrwałe znieczulenie
                  dożylne, bez stosowania środków zwiotczających mięśnie, prowadzone
                  na własnym oddechu pacjenta z zabezpieczeniem drożności dróg oddechowych
                  i z podażą tlenu do oddychania.
                </p>
                <a href="https://www.lipsum.com" target="_blank">
                  <button className="bg-teal-600 text-white py-3 px-8 mt-4 rounded-full shadow-md hover:bg-teal-700 transition duration-300">
                    Sprawdź nasze usługi
                  </button>
                </a>
              </div>
          ...
          <div className="container mx-auto text-center">
            <div className="flex flex-col md:flex-row justify-center items-center mt-8 space-y-4 md:space-y-0 md:space-x-6">
              ...
              <div className="md:w-1/2 text-left">
                ...
                <p className="mb-4">
                  Stomatologia to dziedzina medycyny zajmująca się profilaktyką, diagnostyką i leczeniem chorób
                  zębów, dziąseł oraz jamy ustnej. W naszej klinice oferujemy kompleksowe usługi stomatologiczne,
                  które obejmują zarówno standardowe zabiegi, jak leczenie próchnicy czy usuwanie kamienia nazębnego,
                  jak i zaawansowane procedury protetyczne, ortodontyczne oraz implantologiczne. Dbamy o komfort
                  pacjentów, stosując nowoczesne metody leczenia i znieczulenia. Nasi specjaliści pomagają w przywróceniu
                  zdrowego uśmiechu, poprawiając estetykę oraz funkcjonalność uzębienia.
                </p>
                <p>
                  Znieczulenie do zabiegów stomatologicznych jest najczęściej znieczuleniem ogólnym.
                  Dokładnie przeprowadzony wywiad, analiza ankiety oraz ewentualne
                  badanie kliniczne decydują o możliwości wykonania znieczulenia ogólnego w trybie ambulatoryjnym.
                </p>
