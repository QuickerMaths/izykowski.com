  ...
  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-expect-error
  const AnesthesiaSection = ({ title, content }) => (
  ...
  const Anesthesia = () => {
    ...
    const showSection = (sectionName: React.SetStateAction<string>) => {
      setSection(sectionName);
    };
      // Scroll to target section smoothly when BulletPoint is clicked
    ...
    return (
        <div className="p-6 bg-gray-100">
          ...
          {/* Kafelki */}
          <div className="flex-col md:flex-row flex justify-center items-center gap-8  mb-8 ">
          ...
          {/* Przyciski do wyświetlania sekcji */}
          <div className="text-center mb-10 space-x-52">
            <button
                onClick={() => showSection('adults')}
                className="px-4 py-2 bg-teal-600 text-white rounded-lg mr-4 hover:bg-teal-700 transition duration-300 ml-auto"
            >
              Znieczulenia u dorosłych
            </button>
            <button
                onClick={() => showSection('children')}
                className="px-4 py-2 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition duration-300 mr-6"
            >
            ...
            <nav className="mx-auto bg-white shadow-md rounded-lg p-4 mb-8 w-full max-w-4xl">
              <ol className="list-decimal pl-6 space-y-2 text-gray-700">
                ...
                <ContraindicationItem>
                  ...
                  <SubList>
                    <BulletPoint>
                      <a href="#dorosli1" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli1"); }} className="hover:text-blue-500">
                        Znieczulanie ogólne - co to jest?
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dorosli2" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli2"); }} className="hover:text-blue-500">
                        Dadatkowe znieczulanie miejscowe
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dorosli3" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli3"); }} className="hover:text-blue-500">
                        Kto wykonuje znieczulenia?
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dorosli4" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli4"); }} className="hover:text-blue-500">
                        Rozmowa przedoperacyjna a znieczulanie
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dorosli5" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli5"); }} className="hover:text-blue-500">
                        Przeciwwskazania bezwzględne ogólnomedyczne u dorosłych do
                        znieczulenia w trybie ambulatoryjnym
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dorosli6" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli6"); }} className="hover:text-blue-500">
                        Badania dodatkowe przed operacją – czy zawsze są niezbędne?
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dorosli7" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli7"); }} className="hover:text-blue-500">
                        Zgoda na znieczulanie
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dorosli8" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli8"); }} className="hover:text-blue-500">
                        Ciąża a znieczulanie
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dorosli9" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli9"); }} className="hover:text-blue-500">
                        Świadek Jehowy
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dorosli10" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli10"); }} className="hover:text-blue-500">
                        Przygotowanie do zabiegu
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dorosli11" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli11"); }} className="hover:text-blue-500">
                        Przygotowanie pacjenta do znieczulenia
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dorosli12" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli12"); }} className="hover:text-blue-500">
                        Samopoczucie po zabiegu
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dorosli13" onClick={(e) => { e.preventDefault(); scrollToSection("dorosli13"); }} className="hover:text-blue-500">
                ...
                <ContraindicationItem>
                  ...
                  <SubList>
                    <BulletPoint>
                      <a href="#dzieci1" onClick={(e) => { e.preventDefault(); scrollToSection("dzieci1"); }} className="hover:text-blue-500">
                        Przed znieczuleniem
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dzieci2" onClick={(e) => { e.preventDefault(); scrollToSection("dzieci2"); }} className="hover:text-blue-500">
                        Znieczulenie
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="#dzieci3" onClick={(e) => { e.preventDefault(); scrollToSection("dzieci3"); }} className="hover:text-blue-500">
                        Możliwe powikłania
                      </a>
                    </BulletPoint>
                    <BulletPoint>
                      <a href="dzieci4" onClick={(e) => { e.preventDefault(); scrollToSection("dzieci4"); }} className="hover:text-blue-500">
