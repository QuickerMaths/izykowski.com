      ...
      <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-8">
          ...
          <div className="flex-1">
            ...
            >
              <p className="text-lg leading-relaxed">{isExpanded ? fullText : shortText}</p>
            </div>
            <button
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-8">
          ...
          <div className="flex-1">
            ...
            >
              <p className="text-lg leading-relaxed">{isExpandedSecond ? loremIpsumFull : loremIpsumShort}</p>
            </div>
            <button
      ...
      <div className="bg-white shadow-lg rounded-lg p-6">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-8">
          ...
          <div className="flex-1">
            <div
              className={`transition-all duration-500 ease-in-out overflow-hidden ${
                isExpandedThird ? 'max-h-full opacity-100' : 'max-h-full opacity-100'
              }`}
            >
              <p className="text-lg leading-relaxed">{isExpandedThird ? loremIpsumFull : loremIpsumShort}</p>
            </div>
            <button
